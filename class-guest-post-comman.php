...
if( ! class_exists('GuestPost_Common') ) :
    class GuestPost_Common {
    	...
    	*/
        public static function check_is_auther_login(){
            ...
            if ( is_user_logged_in() && in_array( GuestPost_ALLOW_ROLE, ( array ) $current_user->roles ) ){ // check user is login with Define constant role.
                return true;
            }else{
                return false;
            }
