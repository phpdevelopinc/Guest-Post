...
if( ! class_exists('Add_Guest_Post') ):
    class Add_Guest_Post extends GuestPost_Common{
    	...
    	*  add_guest_post
    	*
    	*  [add_guest_post] call function
    	*  @type	function
    	*
    	*  @param	atts,content
    	*  @return	HTML form
    	*/
        public static function add_guest_post($atts, $content = null) {
            ...
            if( true === $is_auther_login){
                ...
                return  wp_sprintf( '<div class="alert alert-warning"> %s  <strong>%s</strong>.</div>', __( 'For add new post please login with user role - ', 'guest-post' ), GuestPost_ALLOW_ROLE );
            }
        }
